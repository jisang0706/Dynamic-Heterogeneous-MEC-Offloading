...
class PaperRunTests(unittest.TestCase):
    def test_parser_uses_queue_aware_training_defaults(self) -> None:
        ...
        self.assertEqual(args.shared_congestion_delta_reference, 10.0)
        self.assertEqual(args.shared_congestion_queue_reference, 20.0)
        ...
        self.assertEqual(args.monotonic_queue_reference, 20.0)
    ...
    def test_scale_profile_keeps_m5_unchanged(self) -> None:
        ...
        self.assertEqual(profile.u_slack, 1.8)
    ...
    def test_scale_profile_tunes_m10_runs(self) -> None:
        ...
        self.assertEqual(profile.server_cpu_ghz, 70.0)
        self.assertEqual(profile.u_slack, 2.4)
        self.assertEqual(profile.initial_offloading_mean_env, 0.55)
        self.assertEqual(profile.initial_power_mean_env, 0.90)
